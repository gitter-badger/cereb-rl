...
from environments.environment_package.abstract_environment import AbstractEnvironment
from environments.environment_package.grid_world import GridWorld
from environments.environment_package.rl_acid_environment import *
from environments.environment_package.visual_combolock import VisualComboLock
from environments.environment_package.noise_gen import get_sylvester_hadamhard_matrix_dim
    ...
    def __init__(self, env_name, config, bootstrap_env=None):
        ...
        if env_name == 'diabcombolock':
            ...
            if bootstrap_env is not None:
                ...
                self.env = DiabolicalCombinationLock(horizon=config["horizon"],
                                                     swap=0.5,
                                                     num_actions=10,
                                                     anti_shaping_reward=config["anti_shaping_reward"],
                                                     noise_type=self.noise_type,
                                                     optimal_reward=config["optimal_reward"],
                                                     anti_shaping_reward2=config["anti_shaping_reward2"],
